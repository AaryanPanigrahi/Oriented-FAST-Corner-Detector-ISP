...
add wave -noupdate -expand -group {Top Level Signals} -expand -group {First Trans Signals} /tb_GaussianConv/DUT/init_trans_kernel
add wave -noupdate -expand -group {Top Level Signals} -expand -group {First Trans Signals} /tb_GaussianConv/DUT/init_trans_kernel_latch
add wave -noupdate -expand -group {Top Level Signals} -expand -group {Comp Latches} /tb_GaussianConv/DUT/compLatch
add wave -noupdate -expand -group {Top Level Signals} -expand -group {Comp Latches} /tb_GaussianConv/DUT/compLatch_prev
add wave -noupdate -expand -group {Kernel Info} -expand -group {Kernel Control} -radix unsigned /tb_GaussianConv/DUT/sigma
add wave -noupdate -expand -group {Kernel Info} -expand -group {Kernel Control} /tb_GaussianConv/DUT/kernel_size
...
add wave -noupdate -group Convolution -radix unsigned /tb_GaussianConv/DUT/input_matrix
add wave -noupdate -group Convolution /tb_GaussianConv/DUT/err
add wave -noupdate -group Convolution /tb_GaussianConv/DUT/blur_complete
add wave -noupdate -group Convolution -radix decimal /tb_GaussianConv/DUT/blurred_pixel
add wave -noupdate -group Convolution /tb_GaussianConv/DUT/conv_done
add wave -noupdate -group ComputeKernel /tb_GaussianConv/DUT/pixel_blur/start
add wave -noupdate -group ComputeKernel /tb_GaussianConv/DUT/pixel_blur/blurred_pixel
add wave -noupdate -group ComputeKernel /tb_GaussianConv/DUT/pixel_blur/done
add wave -noupdate -group ComputeKernel -expand -group {Done Pr} -color Aquamarine /tb_GaussianConv/DUT/pixel_blur/contConv
add wave -noupdate -group ComputeKernel -expand -group {Done Pr} /tb_GaussianConv/DUT/pixel_blur/end_pos
add wave -noupdate -group ComputeKernel -expand -group {Done Pr} /tb_GaussianConv/DUT/pixel_blur/readyFlag
add wave -noupdate -group ComputeKernel /tb_GaussianConv/DUT/pixel_blur/cur_x
add wave -noupdate -group ComputeKernel /tb_GaussianConv/DUT/pixel_blur/cur_y
add wave -noupdate -group ComputeKernel /tb_GaussianConv/DUT/pixel_blur/kernel_v
add wave -noupdate -group ComputeKernel /tb_GaussianConv/DUT/pixel_blur/pixel_v
add wave -noupdate -group ComputeKernel /tb_GaussianConv/DUT/pixel_blur/clear_flag
add wave -noupdate -group ComputeKernel -group {Accumulator Module} /tb_GaussianConv/DUT/pixel_blur/get_accumulator/kernel_v
add wave -noupdate -group ComputeKernel -group {Accumulator Module} /tb_GaussianConv/DUT/pixel_blur/get_accumulator/pixel_v
add wave -noupdate -group ComputeKernel -group {Accumulator Module} /tb_GaussianConv/DUT/pixel_blur/get_accumulator/start
add wave -noupdate -group ComputeKernel -group {Accumulator Module} /tb_GaussianConv/DUT/pixel_blur/get_accumulator/ready
add wave -noupdate -group ComputeKernel -group {Accumulator Module} /tb_GaussianConv/DUT/pixel_blur/get_accumulator/clear_flag
add wave -noupdate -group ComputeKernel -group {Accumulator Module} /tb_GaussianConv/DUT/pixel_blur/get_accumulator/sum
add wave -noupdate -group ComputeKernel -group {Accumulator Module} /tb_GaussianConv/DUT/pixel_blur/get_accumulator/state
add wave -noupdate -group ComputeKernel -group {Accumulator Module} /tb_GaussianConv/DUT/pixel_blur/get_accumulator/nextState
add wave -noupdate -group ComputeKernel -group {Accumulator Module} /tb_GaussianConv/DUT/pixel_blur/get_accumulator/nextSum
add wave -noupdate -group ComputeKernel -group {Accumulator Module} /tb_GaussianConv/DUT/pixel_blur/get_accumulator/bufferSum
add wave -noupdate -group ComputeKernel -group {Accumulator Module} /tb_GaussianConv/DUT/pixel_blur/get_accumulator/temp_kv
add wave -noupdate -group ComputeKernel -group {Accumulator Module} /tb_GaussianConv/DUT/pixel_blur/get_accumulator/temp_pv
add wave -noupdate -group ComputeKernel -group {Accumulator Module} /tb_GaussianConv/DUT/pixel_blur/get_accumulator/product
add wave -noupdate -group ComputeKernel -group {Accumulator Module} /tb_GaussianConv/DUT/pixel_blur/get_accumulator/nextProduct
...
WaveRestoreCursors {{Cursor 1} {294930 ps} 0}
...
update
WaveRestoreZoom {3507 ps} {472967 ps}
