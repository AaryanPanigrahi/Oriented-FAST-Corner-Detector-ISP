...
add wave -noupdate -radix binary -childformat {{{/tb_CreateKernel/kernel[2]} -radix binary -childformat {{{[2]} -radix binary} {{[1]} -radix binary} {{[0]} -radix binary}}} {{/tb_CreateKernel/kernel[1]} -radix binary -childformat {{{[2]} -radix binary} {{[1]} -radix binary} {{[0]} -radix binary}}} {{/tb_CreateKernel/kernel[0]} -radix binary -childformat {{{[2]} -radix binary} {{[1]} -radix binary} {{[0]} -radix binary}}}} -expand -subitemconfig {{/tb_CreateKernel/kernel[2]} {-height 16 -radix binary -childformat {{{[2]} -radix binary} {{[1]} -radix binary} {{[0]} -radix binary}} -expand} {/tb_CreateKernel/kernel[2][2]} {-radix binary} {/tb_CreateKernel/kernel[2][1]} {-radix binary} {/tb_CreateKernel/kernel[2][0]} {-radix binary} {/tb_CreateKernel/kernel[1]} {-height 16 -radix binary -childformat {{{[2]} -radix binary} {{[1]} -radix binary} {{[0]} -radix binary}} -expand} {/tb_CreateKernel/kernel[1][2]} {-radix binary} {/tb_CreateKernel/kernel[1][1]} {-radix binary} {/tb_CreateKernel/kernel[1][0]} {-radix binary} {/tb_CreateKernel/kernel[0]} {-height 16 -radix binary -childformat {{{[2]} -radix binary} {{[1]} -radix binary} {{[0]} -radix binary}} -expand} {/tb_CreateKernel/kernel[0][2]} {-radix binary} {/tb_CreateKernel/kernel[0][1]} {-radix binary} {/tb_CreateKernel/kernel[0][0]} {-radix binary}} /tb_CreateKernel/kernel
...
add wave -noupdate -expand -group {Module Signals} -radix decimal /tb_CreateKernel/DUT/kernel
...
add wave -noupdate -expand -group {Module Signals} -radix decimal -childformat {{{/tb_CreateKernel/DUT/nnKernel[2]} -radix decimal -childformat {{{[2]} -radix decimal} {{[1]} -radix decimal} {{[0]} -radix decimal}}} {{/tb_CreateKernel/DUT/nnKernel[1]} -radix decimal -childformat {{{[2]} -radix decimal} {{[1]} -radix decimal} {{[0]} -radix decimal}}} {{/tb_CreateKernel/DUT/nnKernel[0]} -radix decimal -childformat {{{[2]} -radix decimal} {{[1]} -radix decimal} {{[0]} -radix decimal}}}} -expand -subitemconfig {{/tb_CreateKernel/DUT/nnKernel[2]} {-height 16 -radix decimal -childformat {{{[2]} -radix decimal} {{[1]} -radix decimal} {{[0]} -radix decimal}} -expand} {/tb_CreateKernel/DUT/nnKernel[2][2]} {-radix decimal} {/tb_CreateKernel/DUT/nnKernel[2][1]} {-radix decimal} {/tb_CreateKernel/DUT/nnKernel[2][0]} {-radix decimal} {/tb_CreateKernel/DUT/nnKernel[1]} {-height 16 -radix decimal -childformat {{{[2]} -radix decimal} {{[1]} -radix decimal} {{[0]} -radix decimal}} -expand} {/tb_CreateKernel/DUT/nnKernel[1][2]} {-radix decimal} {/tb_CreateKernel/DUT/nnKernel[1][1]} {-radix decimal} {/tb_CreateKernel/DUT/nnKernel[1][0]} {-radix decimal} {/tb_CreateKernel/DUT/nnKernel[0]} {-height 16 -radix decimal -childformat {{{[2]} -radix decimal} {{[1]} -radix decimal} {{[0]} -radix decimal}} -expand} {/tb_CreateKernel/DUT/nnKernel[0][2]} {-radix decimal} {/tb_CreateKernel/DUT/nnKernel[0][1]} {-radix decimal} {/tb_CreateKernel/DUT/nnKernel[0][0]} {-radix decimal}} /tb_CreateKernel/DUT/nnKernel
...
WaveRestoreCursors {{Cursor 1} {479912 ps} 0}
...
update
WaveRestoreZoom {0 ps} {960688 ps}
